...
export default function ProjectsContainer({
  ...
  return (
    <div className="select-none flex flex-col items-start gap-y-1 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-primary/20 hover:shadow-[0px_0px_15px_1px] w-full rounded-2xl dark:bg-[#0C1015] border dark:border-gray-800 p-4">
